            ...
            <div className="flex flex-wrap items-center pb-12 justify-center">
              <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                <div className="py-2 text-color">
                  <h1 className="text-2xl  md:leading-snug tracking-tighter font-black">
                    Company A
                  </h1>
                  <h2 className="text-md  lg:leading-7 md:leading-10 py-4 md:py-8">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Suspendisse ac porttitor dui, ac lacinia risus. Pellentesque
                    ipsum odio, dignissim ac felis quis, sollicitudin fermentum
                    libero.
                  </h2>
                  <div className="flex items-center cursor-pointer pb-4 md:pb-0">
                    <h3 className=" text-lg lg:text-2xl font-semibold underline text-indigo-700">
                      Lorem ipsum dolor
                    </h3>
                  </div>
                </div>
          ...
          <div className="mx-auto">
            <div className="flex flex-wrap flex-row-reverse items-center">
              <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                <div className="py-2 text-color">
                  <h1 className="text-2xl lg:text-6xl tracking-tighter md:leading-snug font-black">
                    Easily manage sales through our invoicing system
                  </h1>
                  <h2 className="text-lg lg:text-3xl leading-7 md:leading-10  py-8">
      ...
      <div className="pt-10 md:pt-40">
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center pb-12">
            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
              <div className="py-2 text-color">
                <h1 className="text-2xl lg:text-6xl md:leading-snug tracking-tighter font-black">
                  Boost adoption of product and services
                </h1>
                <h2 className="text-lg lg:text-3xl lg:leading-7 md:leading-10  py-4 md:py-8">
