...
export function NumberComponent(props) {
  return (
    <div class="flex flex-col items-center justify-center border bg-gray-50 rounded-xl py-8 px-20 shadow-sm shadow-gray-200 relative">
      <div class="mb-2 text-3xl md:text-4xl font-extrabold text-gray-900">
        {props.number}
      </div>
      <div class="font-light text-gray-600 "> {props.type}</div>
